...
function Character() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/descarga.jpg";
 ...
 this.update = function () {
  if (keyboard.getPressed() == ' ') {
   this.image.src = "Imagenes/descarga.jpg";
...
function Kamehameha() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/2.jpeg";
...
function Shot() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/4.jpg";
...
var world = new Image(); world.src = "Imagenes/7.jpg";
...
var winbox = new Image(); winbox.src = "Imagenes/6.png";
var lostbox = new Image(); lostbox.src = "Imagenes/6.jpg";
